...
[![Offline First](https://img.shields.io/badge/Offline--First-Защищено-7CFFC4?style=for-the-badge)](https://github.com/Flux-Tasks/Flux-Tasks)
...
* **Управление состоянием**: React Context + local-first SQLite
...
1. **Скачайте веб-установщик**:
   загрузите установочный пакет напрямую со страницы [GitHub Releases](https://github.com/Flux-Tasks/Flux-Tasks/releases/latest).
...
GITHUB_OWNER=Flux-Tasks
GITHUB_REPO=Flux-Tasks

# URL для проверки клиентом автоматических OTA-обновлений
UPDATE_MANIFEST_URL=https://github.com/Flux-Tasks/Flux-Tasks/releases/latest/download/latest.json
```

Официальные ссылки:

* Репозиторий: https://github.com/Flux-Tasks/Flux-Tasks
* Релизы: https://github.com/Flux-Tasks/Flux-Tasks/releases
* Issues: https://github.com/Flux-Tasks/Flux-Tasks/issues
* Исходный код и документация: https://github.com/Flux-Tasks/Flux-Tasks#readme
...
5. **Репозиторий GitHub**: целевой владелец/репозиторий — по умолчанию значение из `.env` или `Flux-Tasks/Flux-Tasks`
...
Official Windows releases of Flux Tasks may be digitally signed to ensure authenticity and integrity.
...
Free code signing may be provided by SignPath Foundation.

For details about the signing process, see [CODE_SIGNING_POLICY.md](CODE_SIGNING_POLICY.md).
